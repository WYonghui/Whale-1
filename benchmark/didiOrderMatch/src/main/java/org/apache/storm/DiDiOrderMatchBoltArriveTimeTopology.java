 ...
 * storm jar didiOrderMatch-2.0.0-SNAPSHOT.jar org.apache.storm.DiDiOrderMatchBoltArriveTimeTopology DiDiOrderMatchLatencyTopology ordersTopic 30 1 30 30
 * storm jar didiOrderMatch-2.0.0-SNAPSHOT.jar org.apache.storm.DiDiOrderMatchBoltArriveTimeTopology DiDiOrderMatchLatencyTopology ordersTopic 7 1 120 1
 */
public class DiDiOrderMatchBoltArriveTimeTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.setBolt(DIDIMATCH_BOLT_ID, new DiDiMatchArriveTimeBolt(),boltInstancesNum).allGrouping(KAFKA_SPOUT_ID,SPOUT_STREAM_ID);

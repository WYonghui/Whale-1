...
import static org.apache.storm.RandomDataSpout.SPOUT_STREAM_ID;
import static org.apache.storm.RandomDataSpout.THROUGHPUT_STREAM_ID;
 ...
 * storm jar didiOrderMatchWhale-2.0.0-SNAPSHOT.jar org.apache.storm.DiDiOrderBalancedPartialMulticastMatchThroughputTopology DiDiOrderMatchThroughputTopology ordersTopic 29 1 rdma 800 2
 * storm jar didiOrderMatchWhale-2.0.0-SNAPSHOT.jar org.apache.storm.DiDiOrderBalancedPartialMulticastMatchThroughputTopology DiDiOrderMatchThroughputTopology ordersTopic 7 1 rdma 800 2
 */
public class DiDiOrderBalancedPartialMulticastMatchThroughputTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Integer degree=Integer.valueOf(args[7]);
        ...
        builder.constructionBalancedPartialMulticast(boltInstancesNum,numworkers-1,degree,KAFKA_SPOUT_ID,SPOUT_STREAM_ID,BROADCAST_STREAM_ID,DiDiMatchBinomialTreeThroughputBolt.class);

        builder.setBolt(THROUGHPUT_BOLT_ID, new ThroughputReportBolt(),1).shuffleGrouping(Constraints.BROADCAST_BOLT+"-"+(numworkers-1),THROUGHPUT_STREAM_ID);

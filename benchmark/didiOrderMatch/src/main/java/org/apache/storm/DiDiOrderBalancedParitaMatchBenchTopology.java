 ...
 * storm jar didiOrderMatch-2.0.0-SNAPSHOT.jar org.apache.storm.DiDiOrderBalancedParitaMatchBenchTopology DiDiOrderMatchThroughputTopology ordersTopic6 31 1 480 2 netty 1000
 * storm jar didiOrderMatch-2.0.0-SNAPSHOT.jar org.apache.storm.DiDiOrderBalancedParitaMatchBenchTopology DiDiOrderMatchThroughputTopology ordersTopic 7 1 28 2 rdma 1000
 */
public class DiDiOrderBalancedParitaMatchBenchTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        graph = builder.constructionBalancedPartialMulticast(boltInstancesNum, numworkers - 1, maxOutDegree, KAFKA_SPOUT_ID, SPOUT_STREAM_ID, BROADCAST_STREAM_ID, DiDiMatchBenchBolt.class);

...
public class DiDiOrderMatchLatencyTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.setSpout(KAFKA_SPOUT_ID, new DiDiOrdersLatencySpout<>(getKafkaSpoutConfig(KAFKA_LOCAL_BROKER,topic)), spoutInstancesNum);
        builder.setBolt(DIDIMATCH_BOLT_ID, new DiDiMatchLatencyBolt(),boltInstancesNum).allGrouping(KAFKA_SPOUT_ID,SPOUT_STREAM_ID);
        builder.setBolt(LATENCY_BOLT_ID,new LatencyReportBolt(),latencyInstancesNum).shuffleGrouping(KAFKA_SPOUT_ID,LATENCY_STREAM_ID);

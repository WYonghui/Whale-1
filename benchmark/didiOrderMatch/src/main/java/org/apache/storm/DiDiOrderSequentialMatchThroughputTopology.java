 ...
 * storm jar didiOrderMatch-2.0.0-SNAPSHOT.jar org.apache.storm.DiDiOrderSequentialMatchThroughputTopology DiDiOrderMatchThroughputTopology ordersTopic6 31 1 480 netty 1000
 * storm jar didiOrderMatch-2.0.0-SNAPSHOT.jar org.apache.storm.DiDiOrderSequentialMatchThroughputTopology DiDiOrderMatchThroughputTopology ordersTopic 7 1 28 rdma 1000
 */
public class DiDiOrderSequentialMatchThroughputTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        graph = builder.constructionSequential(boltInstancesNum, numworkers - 1, KAFKA_SPOUT_ID, SPOUT_STREAM_ID, DiDiMatchBinomialTreeThroughputBolt.class);

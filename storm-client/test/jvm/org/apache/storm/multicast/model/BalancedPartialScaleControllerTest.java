...
import org.apache.storm.multicast.dynamicswitch.BalancedPartialScaleController;
import org.apache.storm.multicast.dynamicswitch.ChangeMsg;
import org.apache.storm.multicast.dynamicswitch.GraphAndChanges;
...
public class BalancedPartialScaleControllerTest {
    ...
    public void testBalancedPartialScaleUp() {
        ...
        GraphAndChanges newOne = BalancedPartialScaleController.change(graph, 1, 3);
        ...
        for (int i = 1; i <= componentNumber; i++) {
            ChangeMsg t = newOne.getChanges().get("component" + i);
            if (t == null) continue;
...
//        System.out.println(Arrays.toString(t));
    ...
    public void testBalancedPartialScaleDown() {
        ...
        long start = System.currentTimeMillis();
        GraphAndChanges newOne = BalancedPartialScaleController.change(graph, 3, 1);
        System.out.println(System.currentTimeMillis() - start);

 ...
 * storm jar didiOrderMatchWhale-2.0.0-SNAPSHOT.jar org.apache.storm.DiDiOrderChainMatchThroughputTopology DiDiOrderMatchThroughputTopology ordersTopic 29 1 rdma 800
 * storm jar didiOrderMatchWhale-2.0.0-SNAPSHOT.jar org.apache.storm.DiDiOrderChainMatchThroughputTopology DiDiOrderMatchThroughputTopology ordersTopic 7 1 rdma 1000
 */
public class DiDiOrderChainMatchThroughputTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        builder.constructionChain(boltInstancesNum,numworkers-1,KAFKA_SPOUT_ID,SPOUT_STREAM_ID,BROADCAST_STREAM_ID,DiDiMatchBinomialTreeThroughputBolt.class);

 ...
 * storm jar didiOrderMatch-2.0.0-SNAPSHOT.jar org.apache.storm.DiDiOrderSequentialMatchBenchTopology DiDiOrderMatchThroughputTopology ordersTopic6 31 1 480 netty 1000
 * storm jar didiOrderMatch-2.0.0-SNAPSHOT.jar org.apache.storm.DiDiOrderSequentialMatchBenchTopology DiDiOrderMatchThroughputTopology ordersTopic 7 1 28 rdma 1000
 */
public class DiDiOrderSequentialMatchBenchTopology {
    ...
    public static void main(String[] args) throws Exception{
        ...
        graph = builder.constructionSequential(boltInstancesNum, numworkers - 1, KAFKA_SPOUT_ID, SPOUT_STREAM_ID, DiDiMatchBenchBolt.class);
